...
pub(crate) const TASK_FIELDS: &[TaskField] = &[
    ...
    field("Parallelism:", true, Some("Parallelism:"), Some(7), Some(7)),
    field("任务级别：", true, Some("任务级别"), Some(8), Some(10)),
    field("Execution effort:", true, None, None, Some(8)),
    field("Workflow authority:", true, None, None, Some(9)),
    field(
        "读取并遵守：",
        false,
        Some("读取并遵守："),
    ...
    field("任务：", false, Some("任务："), Some(10), Some(12)),
    field("背景：", false, Some("背景："), Some(11), Some(13)),
    field("项目画像：", false, Some("项目画像："), Some(12), Some(14)),
    field("记忆胶囊：", false, Some("记忆胶囊："), Some(13), Some(15)),
    field("任务存档：", false, Some("任务存档："), Some(14), Some(16)),
    ...
    field("相关路径：", false, Some("相关路径："), Some(16), Some(19)),
    field(
        "本次任务相关文件：",
        false,
        Some("本次任务相关文件："),
    ...
    field("目标：", false, Some("目标："), Some(18), Some(21)),
    field("验收标准：", false, Some("验收标准："), Some(19), Some(22)),
    field("非目标：", false, Some("非目标："), Some(20), Some(23)),
    field("子任务编排：", false, None, None, Some(24)),
    field("实施要求：", false, None, None, Some(25)),
    field("关键路径：", false, None, None, None),
    field("验证：", false, Some("验证："), Some(21), Some(26)),
    field(
        "Verification gate:",
        false,
    ...
    field("交付：", false, Some("交付："), Some(23), Some(28)),
];
