...
mod tests {
    ...
    fn sample_report() -> HealthReport {
        let mut report = HealthReport::new("Suite Diagnostics v0.1.0");
        ...
        report.add(Finding::info("suite-version", "suite-doctor v0.1.0"));
    ...
    fn text_report_includes_title_and_status() {
        ...
        assert!(text.contains("Suite Diagnostics v0.1.0"));
    ...
    fn json_report_is_valid_json() {
        ...
        assert_eq!(parsed["title"], "Suite Diagnostics v0.1.0");
