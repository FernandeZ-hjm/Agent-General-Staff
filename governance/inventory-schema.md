...
Data YAML files under `tools/agent-toolchain/data/` may record paths as captured
on the machine where the inventory was originally generated, for example
`$HOME/.agents/skills/...`. These are **inventory record paths**, not runtime
paths.
