...
current product version and latest release are **v0.3.7**.

## v0.3.7 governance flow
...
The v0.3.7 runtime workspace exposes exactly twelve authoritative Cargo
packages:
...
implementations have moved under their authoritative modules. v0.3.7 retains
...
v0.3.7 supports only the current command surface below. Removed legacy
...
- Latest: **v0.3.7**
- Current contract: v0.3.7 human/Machine CLI
...
2. Align Cargo, npm, manifests, docs, and release notes to `0.3.7`.
3. The maintainer explicitly pushes the annotated `v0.3.7` tag.
...
5. After the Release assets are complete, manually dispatch the npm OIDC
   ...
   `@agent-governance-suite/mcp@0.3.7` as latest.
